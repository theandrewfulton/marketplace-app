...
class ListingsTest < ApplicationSystemTestCase
  ...
  test "creating a Listing" do
    ...
    fill_in "Quantity available", with: @listing.quantity_available
    fill_in "Quantity total", with: @listing.quantity_total
    fill_in "Rating", with: @listing.rating
    fill_in "Reviews", with: @listing.reviews
    check "Sold" if @listing.sold
    fill_in "Title", with: @listing.title
    fill_in "Unit", with: @listing.unit
    fill_in "User", with: @listing.user
